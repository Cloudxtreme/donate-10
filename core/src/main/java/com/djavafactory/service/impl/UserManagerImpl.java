...
import com.djavafactory.dao.UserDao;
import com.djavafactory.model.User;
import com.djavafactory.service.MailEngine;
import com.djavafactory.service.UserExistsException;
import com.djavafactory.service.UserManager;
import com.djavafactory.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.djavafactory.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.djavafactory.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
